...
<title>Registraction from</title>
</head>
       ...
       <div>
        ...
        <button style="background-color:white;font-size:18px;text-align: right ;" type="button"
            ...
            <div class="div">
                ...
                <img src="IconJpg/profile.png.png" height="150" width="100"><br>

                </div>
                <div>
                    <form  action =" RegisterS"id="demo" class="myfdiv">
                        ...
                        <lable class="clabel" type="text">M.no</lable><br>
                         
                        <input type="number" name=fmno><br>
                        <lable class="clabel" type="text">DOB</lable><br>
                        <input type="Date" name ="fdob"><br>
